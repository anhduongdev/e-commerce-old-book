    ...
    return (
      <div className="flex items-center gap-3 rounded-lg border border-border bg-bg-secondary p-3">
        ...
        <div className="min-w-0 flex-1">
          <p className="truncate text-sm font-medium text-text">{value.split("/").pop()}</p>
          <button
            type="button"
  ...
  return (
    <div>
      ...
      >
        ...
        <p className="text-xs text-text-secondary">Định dạng: JPG, PNG, WEBP. Kích thước tối đa 2MB.</p>
      </div>
      <input
        ref={inputRef}
        type="file"
