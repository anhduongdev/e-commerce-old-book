    ...
    return (
      <div className="flex items-center gap-3 rounded-lg border border-brand-100 bg-cream-dark p-3">
        ...
        <div className="min-w-0 flex-1">
          <p className="truncate text-sm font-medium text-brand-900">{value.split("/").pop()}</p>
          <button
            type="button"
  ...
  return (
    <div>
      ...
      >
        ...
        <p className="text-xs text-brand-600">Định dạng: JPG, PNG, WEBP. Kích thước tối đa 2MB.</p>
      </div>
      <input
        ref={inputRef}
        type="file"
